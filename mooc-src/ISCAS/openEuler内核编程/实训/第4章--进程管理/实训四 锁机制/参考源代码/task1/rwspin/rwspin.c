...
{	
	...
	while(!kthread_should_stop())
	{
        ...
        write_file("Thread one get: ", "/root/rwspin/output");
        write_file(info, "/root/rwspin/output");
        kfree(info);
        setMyVar(i);
        info = itos(getMyVar());
        write_file("Thread one set: ", "/root/rwspin/output");
        write_file(info, "/root/rwspin/output");
        kfree(info);
...
{	
	...
	while(!kthread_should_stop())
	{
        ...
        write_file("Thread two get: ", "/root/rwspin/output");
        write_file(info, "/root/rwspin/output");
        kfree(info);
        setMyVar(j);
        info = itos(getMyVar());
        write_file("Thread two set: ", "/root/rwspin/output");
        write_file(info, "/root/rwspin/output");
        kfree(info);
